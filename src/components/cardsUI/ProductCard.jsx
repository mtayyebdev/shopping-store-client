      ...
      <div className={`group bg-white ${classes} overflow-hidden`}>
        ...
        <div className="relative overflow-hidden bg-gray-100">
          ...
          {save && (
            ...
            >
              <LuHeart
                className={`w-4 h-4 md:w-5 md:h-5 ${isWishlisted ? "fill-current" : ""
                  }`}
              />
            </button>
          )}
          ...
          <div className="aspect-square relative">
            ...
            <img
              ...
              className={`w-full rounded h-full object-cover transform group-hover:scale-110 transition-transform duration-500 ${imageLoaded ? "opacity-100" : "opacity-0"
                }`}
            />
          </div>
        </div>
