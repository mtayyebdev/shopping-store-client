...
import { getDeliveryBoy } from "../../../store/publicSlices/DeliveryBoySlice.jsx";
...
function Login() {
    ...
    const loginHandler = async (e) => {
        ...
        try {
            const res = await axios.post(`${import.meta.env.VITE_SERVER_URL}/api/rider/login`, {
                phone: data.phone,
    ...
    return (
        <>
            <div className="container-full bg-secondary flex items-center justify-center flex-col w-full h-screen p-4">
                ...
                <p className="mb-10">Welcome Delivery Boy!</p>
