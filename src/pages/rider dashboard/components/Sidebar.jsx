...
import { logoutDeliveryBoy } from '../../../store/publicSlices/DeliveryBoySlice'
    ...
    <>
      ...
      >
        ...
        <div className={`flex items-center h-20 px-4 ${sidebarToggle ? "justify-center" : "justify-between"}`}>
          {!sidebarToggle && (
            <Link to="/web-rider" className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900 dark:text-white">Rider</h1>
          ...
          {sidebarToggle && (
            <NavLink to="/web-rider" className="w-10 h-10 rounded-xl bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center">
              <span className="text-white font-bold text-lg">R</span>
            </NavLink>
          )}
        </div>
